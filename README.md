...
- **Backend (Python/Flask)**
  ...
  - `recommendation_service` (Porta 5006)
- **Frontend (C# / Blazor)**
...
2. Explora o Catálogo, recebe recomendações baseadas no seu histórico via `recommendation_service`, e escolhe um livro disponível.
